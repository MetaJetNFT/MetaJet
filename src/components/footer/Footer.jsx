        ...
        <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div class="flex flex-col">
                ...
                <div class="flex mt-4 mb-10 flex-row justify-center">
                    ...
                    <a href="#crewpass" class="mx-10 hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">About Us</a>
                    <a href="#roadmap" class="mx-10 hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Road Map</a>
                    <a href="#team" class="mx-10 hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Team</a>
